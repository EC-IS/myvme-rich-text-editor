...
function p3() {
  if (L1)
    return Z;
  L1 = 1;
  var r = O1, C = Symbol.for("react.element"), v = Symbol.for("react.fragment"), b = Object.prototype.hasOwnProperty, g = r.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, T = { key: !0, ref: !0, __self: !0, __source: !0 };
  function R(y, h, _) {
    var c, m = {}, S = null, V = null;
    _ !== void 0 && (S = "" + _), h.key !== void 0 && (S = "" + h.key), h.ref !== void 0 && (V = h.ref);
    for (c in h)
      b.call(h, c) && !T.hasOwnProperty(c) && (m[c] = h[c]);
    if (y && y.defaultProps)
      for (c in h = y.defaultProps, h)
        m[c] === void 0 && (m[c] = h[c]);
    return { $$typeof: C, type: y, key: S, ref: V, props: m, _owner: g.current };
  }
  return Z.Fragment = v, Z.jsx = R, Z.jsxs = R, Z;
}
var N = {};
/**
 * @license React
...
function x3() {
  return M1 || (M1 = 1, process.env.NODE_ENV !== "production" && function() {
    var r = O1, C = Symbol.for("react.element"), v = Symbol.for("react.portal"), b = Symbol.for("react.fragment"), g = Symbol.for("react.strict_mode"), T = Symbol.for("react.profiler"), R = Symbol.for("react.provider"), y = Symbol.for("react.context"), h = Symbol.for("react.forward_ref"), _ = Symbol.for("react.suspense"), c = Symbol.for("react.suspense_list"), m = Symbol.for("react.memo"), S = Symbol.for("react.lazy"), V = Symbol.for("react.offscreen"), i1 = Symbol.iterator, P1 = "@@iterator";
    function A1(e) {
    ...
    var F1 = !1, D1 = !1, Z1 = !1, N1 = !1, V1 = !1, s1;
    s1 = Symbol.for("react.module.reference");
    function B1(e) {
      return !!(typeof e == "string" || typeof e == "function" || e === b || e === T || V1 || e === g || e === _ || e === c || N1 || e === V || F1 || D1 || Z1 || typeof e == "object" && e !== null && (e.$$typeof === S || e.$$typeof === m || e.$$typeof === R || e.$$typeof === y || e.$$typeof === h || // This needs to include all possible module reference object
...
`), w = a.stack.split(`
`), p = i.length - 1, x = w.length - 1; p >= 1 && x >= 0 && i[p] !== w[x]; )
            x--;
          for (; p >= 1 && x >= 0; p--, x--)
            if (i[p] !== w[x]) {
              if (p !== 1 || x !== 1)
...
` + i[p].replace(" at new ", " at ");
        ...
        X = !1, G.current = u, Y1(), Error.prepareStackTrace = l;
      }
          ...
          if (u(e, s)) {
            ...
            try {
              if (typeof e[s] != "function") {
                var w = Error((a || "React class") + ": " + o + " type `" + s + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + typeof e[s] + "`.This often happens because of typos such as `PropTypes.function` instead of `PropTypes.func`.");
    ...
    function m1(e) {
      if (Q1(e))
        return E("The provided key is an unsupported type %s. This value must be coerced to a string before before using it here.", X1(e)), _1(e);
    }
    ...
    function o3(e, t) {
      {
        var o = function() {
          E1 || (E1 = !0, E("%s: `key` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", t));
        };
    ...
    function a3(e, t) {
      {
        var o = function() {
          w1 || (w1 = !0, E("%s: `ref` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", t));
        };
    ...
    function s3(e, t, o, a, l) {
      {
        var u, s = {}, i = null, w = null;
        o !== void 0 && (m1(o), i = "" + o), r3(t) && (m1(t.key), i = "" + t.key), t3(t) && (w = t.ref, n3(t, l));
        for (u in t)
        ...
        return i3(e, i, w, l, a, D.current, s);
      }
    }
    ...
    function H1(e, t) {
      {
        ...
        R1[o] = !0;
        var a = "";
        e && e._owner && e._owner !== t1.current && (a = " It was passed a child from " + k(e._owner.type) + "."), $(e), E('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', o, a), $(null);
      }
    }
    function T1(e, t) {
      {
    ...
    function S1(e, t, o, a, l, u) {
      {
        ...
        if (!s) {
          ...
          w ? i += w : i += j1();
          var p;
          e === null ? p = "null" : Q(e) ? p = "array" : e !== void 0 && e.$$typeof === C ? (p = "<" + (k(e.type) || "Unknown") + " />", i = " Did you accidentally export a JSX literal instead of a component?") : p = typeof e, E("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", p, i);
        }
        var x = s3(e, t, o, l, u);
        if (x == null)
          return x;
...
const b3 = (r) => /* @__PURE__ */ d.createElement("svg", { width: 9, height: 12, viewBox: "0 0 9 12", fill: "none", xmlns: "http://www.w3.org/2000/svg", ...r }, /* @__PURE__ */ d.createElement("path", { d: "M1.73077 12C1.25481 12 0.847356 11.8321 0.508413 11.4964C0.169471 11.1607 0 10.7571 0 10.2857V1.71429C0 1.24286 0.169471 0.839286 0.508413 0.503571C0.847356 0.167857 1.25481 0 1.73077 0H4.78125C5.71875 0 6.58413 0.285714 7.3774 0.857143C8.17067 1.42857 8.56731 2.22143 8.56731 3.23571C8.56731 3.96429 8.40144 4.525 8.06971 4.91786C7.73798 5.31071 7.42788 5.59286 7.13942 5.76429C7.5 5.92143 7.90024 6.21429 8.34014 6.64286C8.78005 7.07143 9 7.71429 9 8.57143C9 9.84286 8.53125 10.7321 7.59375 11.2393C6.65625 11.7464 5.77644 12 4.95433 12H1.73077ZM2.61779 9.6H4.86779C5.5601 9.6 5.98197 9.425 6.13341 9.075C6.28486 8.725 6.36058 8.47143 6.36058 8.31429C6.36058 8.15714 6.28486 7.90357 6.13341 7.55357C5.98197 7.20357 5.53846 7.02857 4.80288 7.02857H2.61779V9.6ZM2.61779 4.71429H4.62981C5.10577 4.71429 5.45192 4.59286 5.66827 4.35C5.88462 4.10714 5.99279 3.83571 5.99279 3.53571C5.99279 3.19286 5.87019 2.91429 5.625 2.7C5.37981 2.48571 5.0625 2.37857 4.67308 2.37857H2.61779V4.71429Z", fill: "#8E99A4" })), _3 = "_btn_4vry3_5", m3 = "_tooltip_4vry3_21", E3 = "_tooltip__text_4vry3_27", w3 = "_selected_4vry3_45", f = {
...
}, a1 = (r) => /* @__PURE__ */ d.createElement("svg", { width: 6, height: 4, viewBox: "0 0 6 4", fill: "none", xmlns: "http://www.w3.org/2000/svg", ...r }, /* @__PURE__ */ d.createElement("path", { opacity: 0.5, d: "M3 4C2.92825 4 2.86099 3.98728 2.79821 3.96183C2.73543 3.93639 2.67713 3.89313 2.62332 3.83206L0.147982 1.0229C0.0493274 0.910941 0 0.768448 0 0.59542C0 0.422392 0.0493274 0.279898 0.147982 0.167939C0.246637 0.0559796 0.372197 0 0.524664 0C0.67713 0 0.802691 0.0559796 0.901345 0.167939L3 2.54962L5.09865 0.167939C5.19731 0.0559796 5.32287 0 5.47534 0C5.6278 0 5.75336 0.0559796 5.85202 0.167939C5.95067 0.279898 6 0.422392 6 0.59542C6 0.768448 5.95067 0.910941 5.85202 1.0229L3.37668 3.83206C3.32287 3.89313 3.26457 3.93639 3.20179 3.96183C3.13901 3.98728 3.07175 4 3 4Z", fill: "#8E99A4" })), N3 = "_open_wdvgn_25", V3 = "_selected_wdvgn_33", A = {
  ...
  const T = h3(null), [R, y] = I(!1), h = () => y(!R), _ = (c) => {
    c.preventDefault(), h(), v(c.target.value);
  };
  return J(() => {
    const c = (m) => {
      const S = m.target;
      T.current && !T.current.contains(S) && y(!1);
    };
    ...
    /* @__PURE__ */ n.jsxs(
      "button",
      {
        ...
        "aria-expanded": R,
        "aria-controls": `custom-select-list-${g}`,
    ...
    /* @__PURE__ */ n.jsx(
      "ul",
      {
        id: `custom-select-list-${g}`,
        className: `${A["custom-select__list"]} ${R ? A.open : ""}`,
        children: r.map((c, m) => /* @__PURE__ */ n.jsx(
          "li",
          {
            className: `${A["custom-select__item"]} ${c === C ? A.selected : ""}`,
            children: /* @__PURE__ */ n.jsxs("label", { htmlFor: `custom-select-${g}-radio-${m}`, children: [
              /* @__PURE__ */ n.jsx(
                "input",
                {
                  type: "radio",
                  id: `custom-select-${g}-radio-${m}`,
                  name: `custom-select-${g}`,
                  value: c,
                  checked: c === C,
                  onChange: _
                }
  ...
  const C = ["Normal", "Heading 1", "Heading 2"], [v, b] = I(C[0]);
  return J(() => {
    switch (v) {
      case "Heading 1":
        r("formatBlock", "<h1>");
...
}, W3 = (r) => /* @__PURE__ */ d.createElement("svg", { width: 9, height: 10, viewBox: "0 0 9 10", fill: "none", xmlns: "http://www.w3.org/2000/svg", ...r }, /* @__PURE__ */ d.createElement("path", { d: "M0.841642 10C0.554712 10 0.327039 9.88393 0.158624 9.65179C-0.00979164 9.41964 -0.0440984 9.17262 0.0557033 8.91071L3.34916 0.535714C3.41154 0.369048 3.51758 0.238095 3.66728 0.142857C3.81698 0.047619 3.97916 0 4.15381 0H4.82747C5.0146 0 5.1799 0.047619 5.32336 0.142857C5.46683 0.238095 5.56975 0.369048 5.63213 0.535714L8.9443 8.92857C9.0441 9.19048 9.00979 9.43452 8.84138 9.66071C8.67296 9.8869 8.44529 10 8.15836 10C7.98371 10 7.82153 9.95238 7.67182 9.85714C7.52212 9.7619 7.41608 9.63095 7.35371 9.46429L6.62391 7.42857H2.39481L1.62758 9.48214C1.5652 9.64881 1.46228 9.77679 1.31882 9.86607C1.17535 9.95536 1.0163 10 0.841642 10ZM2.91877 6H6.06252L4.52807 1.85714H4.45322L2.91877 6Z", fill: "#8E99A4" })), Y3 = ({ handleCommand: r }) => {
  const [C, v] = I("#3C4D5D"), b = (g) => {
    g.preventDefault(), v(g.target.value), r("foreColor", g.target.value);
  };
  ...
  visible: Q3,
  editor: e6
}, r6 = ({ editorRef: r, editorContainerRef: C, defaultValue: v = "" }) => {
  const [b, g] = I(!1);
  J(() => (r.current && v && (r.current.innerHTML = v), document.addEventListener("mousedown", h), () => {
    document.removeEventListener("mousedown", h);
  }), []);
  const T = () => {
    var _;
    console.log(r), console.log("Input detected:", (_ = r.current) == null ? void 0 : _.innerHTML);
  }, R = (_, c) => {
    console.log(`Executing command: ${_}`, c), r.current && (document.execCommand(_, !1, c === null ? void 0 : c), r.current.focus());
  }, y = () => g(!0), h = (_) => {
    C.current && !C.current.contains(_.target) && g(!1);
  };
  return /* @__PURE__ */ n.jsxs("div", { className: q.MyVMERichTextEditor, ref: C, children: [
    /* @__PURE__ */ n.jsx("div", { className: `${q.toolbar} ${b ? q.visible : ""}`, children: /* @__PURE__ */ n.jsx(G3, { handleCommand: R }) }),
    /* @__PURE__ */ n.jsx(
      "div",
      {
        ref: r,
